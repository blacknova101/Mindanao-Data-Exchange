...
<body>
    ...
    <div class="container">
        <div class="dataset-header">
            <h2>Global Urban Expansion Trends 2024</h2>
        </div>
        <div class="dataset-content">
            <div class="dataset-text">
                <p>This dataset provides an analysis of urban expansion across major cities worldwide, tracking changes in land use, population density, and infrastructure development. It includes satellite imagery, zoning data, and growth projections to assess the impact of urbanization on the environment and economy.</p>
            </div>
            <div class="dataset-image">
                <img src="images/viewpic1.png" alt="Stock Market Data">
            </div>
        </div>
        <div class="info-image">
            <img src="images/viewpic1.1.png" alt="Additional Data Visualization">
        </div>
        <div class="info-resources-container">
            <div class="additional-info">
                <h3>Additional Information</h3>
                <p><strong>Time Period:</strong> January 10,  2020 - December 22,  2024</p>
                <p><strong>Location:</strong> Philippines</p>
                <p><strong>Source:</strong> Urban Development Research Institute (UDRI)</p>
                <p><strong>Link:</strong> <a href="#">www.udri-ph.org/urban-trends-2024</a></p>
            </div>
            <div class="resources">
                <h3>Data and Resources</h3>
                <ul>
                    <li><a href="#">urban-trends-2024.csv</a></li>
                    <li><a href="#">urban-trends-2024_metadata.json</a></li>
                </ul>
            </div>
        </div>
    </div>
