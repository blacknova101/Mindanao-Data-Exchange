...
<body>
    ...
    <div class="container">
        <div class="dataset-header">
            <h2>GReal-Time Traffic Patterns & Congestion Data</h2>
        </div>
        <div class="dataset-content">
            <div class="dataset-text">
                <p>This dataset tracks live traffic conditions and congestion levels across major urban areas. It includes GPS-based vehicle movement data, road sensor inputs, and historical traffic trends to analyze peak congestion hours, accident hotspots, and traffic flow efficiency.</p>
            </div>
            <div class="dataset-image">
                <img src="images/viewpic2.png" alt="Stock Market Data">
            </div>
        </div>
        <div class="info-image">
            <img src="images/viewpic2.1.png" alt="Additional Data Visualization">
        </div>
        <div class="info-resources-container">
            <div class="additional-info">
                <h3>Additional Information</h3>
                <p><strong>Time Period:</strong> January 19, 2019 - December 31, 2023</p>
                <p><strong>Location:</strong> Philippines</p>
                <p><strong>Source:</strong> Philippine Traffic Monitoring Authority (PTMA)</p>
                <p><strong>Link:</strong> <a href="#">www.ptma.gov.ph/traffic-data</a></p>
            </div>
            <div class="resources">
                <h3>Data and Resources</h3>
                <ul>
                    <li><a href="#">traffic-data.csv</a></li>
                    <li><a href="#">traffic-data_metadata.json</a></li>
                </ul>
            </div>
        </div>
    </div>
